...
//         Assert.assertEquals(kingMove2.getBoardRep(), "rnbq1bnr/8/4k3/8/8/8/8/RNBQKBNR w KQkq - 0 1");
        ...
        Assert.assertEquals(checkmateMove.getBoardRep(), "k7/8/6r1/8/5b2/5q2/7K/8 w KQ - 0 1");
        ...
        Assert.assertEquals(checkmateMove2.getBoardRep(), "8/8/k7/8/8/1R6/R7/5K2 b KQ - 0 1");
        ...
        Assert.assertEquals(checkmateMove3.getBoardRep(), "3q4/8/7k/4n3/7K/1r6/8/8 w KQ - 0 1");
        ...
        Assert.assertEquals(checkmateMove4.getBoardRep(), "4k3/3PP3/4K3/8/8/8/8/8 b kq - 0 1");
        ...
        Assert.assertEquals(checkmateMove5.getBoardRep(), "R5k1/5ppp/6r1/8/8/7P/5PP1/6K1 b K - 0 1");
        ...
        Assert.assertEquals(checkmateMove6.getBoardRep(), "r4rk1/ppp2pQp/8/8/8/1P6/P4PPP/B4RK1 b KQ - 0 1");
        ...
        Assert.assertEquals(checkmateMove7.getBoardRep(), "r5rk/ppp2Npp/8/8/8/1P6/P4PPP/5RK1 b KQ - 0 1");
        ...
        Assert.assertEquals(checkmateMove8.getBoardRep(), "r4rk1/ppp2p1p/5BpN/8/8/1P6/P4PPP/5RK1 b KQ - 0 1");
        ...
        Assert.assertEquals(checkMove2.getBoardRep(), "8/2k5/6p1/8/8/2Q5/7K/r7 b KQ - 0 1");
        ...
        Assert.assertEquals(checkMove3.getBoardRep(), "2n5/k3Q3/8/1p6/p6P/P3b3/8/5K2 b KQ - 0 1");
